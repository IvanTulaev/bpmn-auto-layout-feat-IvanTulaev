  ...
  if (isBoundary) {
    ...
    if (dX < 0 && dY === 0) {
      return [
        ...
        { x: sourceMid.x, y: sourceY + (!baseSource.isExpanded ? DEFAULT_CELL_HEIGHT : DEFAULT_CELL_HEIGHT * (baseSource.grid.colCount + 1.5)) },
        { x: targetMid.x, y: sourceY + (!baseSource.isExpanded ? DEFAULT_CELL_HEIGHT : DEFAULT_CELL_HEIGHT * (baseSource.grid.colCount + 1.5)) },
        getDockingPoint(targetMid, targetBounds, 'b', dockingTarget)
      ];
    }
